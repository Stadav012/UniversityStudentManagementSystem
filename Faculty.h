	...
	public:
		...
		void viewRoster() {
			...
			try {
				...
				// Prepare SQL command
				MySqlCommand^ sqlCmd = gcnew MySqlCommand("SELECT Students.student_id, users.fname, users.lname, users.email, Courses.courseName FROM Enrollments INNER JOIN Students ON Enrollments.student_id = Students.student_id INNER JOIN Users ON Students.user_id = Users.user_id INNER JOIN Courses ON Enrollments.course_id = Courses.course_id WHERE Courses.faculty_id = @facultyID;", sqlConn);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->menuStrip1->Size = System::Drawing::Size(1576, 24);
			...
			this->button1->Location = System::Drawing::Point(1390, 3);
			...
			this->dataGridView1->Location = System::Drawing::Point(301, 182);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 62;
			this->dataGridView1->RowTemplate->Height = 28;
			this->dataGridView1->Size = System::Drawing::Size(783, 289);
			...
			this->deleteButton->Location = System::Drawing::Point(206, 2);
			this->deleteButton->Name = L"deleteButton";
			this->deleteButton->Size = System::Drawing::Size(188, 35);
			...
			this->viewStudents_Click->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->viewStudents_Click->Name = L"viewStudents_Click";
			this->viewStudents_Click->Size = System::Drawing::Size(182, 37);
			...
			this->viewCourses->Location = System::Drawing::Point(567, 0);
			this->viewCourses->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->viewCourses->Name = L"viewCourses";
			this->viewCourses->Size = System::Drawing::Size(182, 37);
			...
			this->viewAssignments->Location = System::Drawing::Point(889, 3);
			this->viewAssignments->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->viewAssignments->Name = L"viewAssignments";
			this->viewAssignments->Size = System::Drawing::Size(182, 37);
			...
			this->Grade->Location = System::Drawing::Point(1233, 2);
			this->Grade->Name = L"Grade";
			this->Grade->Size = System::Drawing::Size(104, 35);
			...
			this->gradeTextBox->Location = System::Drawing::Point(1116, 5);
			this->gradeTextBox->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->gradeTextBox->MaxLength = 3;
			this->gradeTextBox->Name = L"gradeTextBox";
			this->gradeTextBox->Size = System::Drawing::Size(108, 26);
			...
			this->ClientSize = System::Drawing::Size(1576, 722);
